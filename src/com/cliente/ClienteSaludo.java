...
public class ClienteSaludo {
	...
	public static void main(String[] args) throws NamingException{
		SaludoBeanRemote saludoBean = (SaludoBeanRemote) InitialContext.doLookup("ModuloEJB/SaludoBean!com.servicios.SaludoBeanRemote");
   		...
   		CarritoDeSaludosBeanRemote carritoDeSaludosBean= (CarritoDeSaludosBeanRemote) InitialContext.doLookup("ModuloEJB/CarritoDeSaludosBean!com.servicios.CarritoDeSaludosBeanRemote");
   		carritoDeSaludosBean.agregarSaludo("A");
   		carritoDeSaludosBean.agregarSaludo("B");
   		carritoDeSaludosBean.agregarSaludo("C");
   		System.out.println(carritoDeSaludosBean.obtenerSaludo());
